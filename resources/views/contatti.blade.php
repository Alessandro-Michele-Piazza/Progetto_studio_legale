<x-layout title="Contatti | Studi Legali Consorziati – Catania" description="Contattateci per una consulenza legale personalizzata. Siamo a vostra disposizione per assistervi in ogni ambito del diritto. Scoprite i nostri recapiti e compilate il modulo di contatto per richiedere un appuntamento con i nostri avvocati esperti." keywords="contatti studio legale, consulenza legale, recapiti, modulo di contatto, avvocati Catania, assistenza legale, diritto civile, diritto penale, diritto del lavoro, diritto di famiglia, diritto amministrativo, diritto tributario, diritto internazionale">
            ...
            <div class="row g-5 align-items-start">
                            ...
                            <li class="contatti-item">
                                ...
                                <div>
                                    ...
                                    <p class="contatti-item-testo">
                                        ...
                                        Riceviamo esclusivamente su appuntamento, per garantire la massima professionalità.
                                    </p>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="col-lg-7">
                    <div class="contatti-card contatti-card--form">
                        ...
                        <form action="{{ route('contatti.send') }}" method="POST" novalidate aria-label="Modulo richiesta consulenza">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <label for="area" class="contatti-form-label">
                                        Area Legale di Interesse <abbr title="Campo obbligatorio" aria-label="obbligatorio">*</abbr>
                                    </label>
                                    <div class="contatti-select-wrapper">
                                        <select
                                            ...
                                            required
                                        >
                                            <option value="" disabled {{ old('area') ? '' : 'selected' }}>Selezionate un'area di competenza</option>
                                            <option value="civile" {{ old('area') === 'civile' ? 'selected' : '' }}>Diritto Civile</option>
                                            <option value="penale" {{ old('area') === 'penale' ? 'selected' : '' }}>Diritto Penale</option>
                                            <option value="lavoro" {{ old('area') === 'lavoro' ? 'selected' : '' }}>Diritto del Lavoro</option>
                                            <option value="famiglia" {{ old('area') === 'famiglia' ? 'selected' : '' }}>Diritto di Famiglia</option>
                                            ...
                                            <option value="altro" {{ old('area') === 'altro' ? 'selected' : '' }}>Altro</option>
                                        </select>
                                        @error('area')
                                            <span class="contatti-field-error">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <label for="messaggio" class="contatti-form-label">
                                        Descrizione della Richiesta <abbr title="Campo obbligatorio" aria-label="obbligatorio">*</abbr>
                                    </label>
                                    <textarea
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-start gap-2">
                                        <input
                                            class="contatti-check-input flex-shrink-0 mt-1"
                                            type="checkbox"
                                            id="privacy"
                                            name="privacy"
                                            required
